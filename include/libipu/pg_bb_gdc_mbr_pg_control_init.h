...
#ifndef __PG_BB_GDC_MBR_CONTROL_INIT_H_
#define __PG_BB_GDC_MBR_CONTROL_INIT_H_
...
enum PG_BB_GDC_MBR_PROGRAM_ID {
	PG_BB_GDC_MBR_PROGRAM_ID_ACC_GDC_MBR,
	PG_BB_GDC_MBR_PROGRAM_ID_N
};
 ...
 * @retval 1    Error.
 */
int _pg_10005_control_payload_init(
...
int _pg_10005_control_init_sec_desc_init(
	const ia_css_process_group_t *process_group,
...
int _pg_10005_get_control_payload_init_buffer_size(
	const ia_css_process_group_t *process_group,
	unsigned int *payload_size);


#endif /* __PG_BB_GDC_MBR_CONTROL_INIT_H_ */
