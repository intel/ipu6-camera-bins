...
#ifndef DFM_DMA_BAYER_INIT_HOST_H_
#define DFM_DMA_BAYER_INIT_HOST_H_

#include "bufqueue.host.h"
#include "dfm_dma_config_port.isp.h"
#include "pg_control_init_support.h"

static void dfm_dma_bayer_host_open(p_terminal_config terminal,
					bufqueue_t q,
					resource_t dma_res,
					unsigned ack_addr,
					unsigned ack_data,
...
#include "dfm_dma_bayer_init.host.c"
#endif

#endif /* DFM_DMA_BAYER_INIT_HOST_H_ */
