 ...
 */
/* TNR input queue configuration */
#define Q_TNR_IN_BUF_MEM                              (buf_mem_tnr_input_vmem)
#define Q_TNR_IN_BUF_START_ADDR                       (0)
#define Q_TNR_IN_NUMBUF                               (3)
#define Q_TNR_IN_WIDTH                                (GDC_OXDIM_DEFAULT)
#define Q_TNR_IN_HEIGHT                               (GDC_OYDIM_DEFAULT)

#define Q_TNR_IN_WIDTH_Y                              (CEIL_DIV(Q_TNR_IN_WIDTH, ISP_NWAY))
#define Q_TNR_IN_HEIGHT_Y                             (Q_TNR_IN_HEIGHT)
#define Q_TNR_IN_SIZE_Y                               (Q_TNR_IN_WIDTH_Y * Q_TNR_IN_HEIGHT_Y)

#define Q_TNR_IN_WIDTH_U                              (CEIL_DIV((Q_TNR_IN_WIDTH >> NCI_TNR_CHROMA_SUBSAMPLE_SHIFT), ISP_NWAY))
#define Q_TNR_IN_HEIGHT_U                             (Q_TNR_IN_HEIGHT_Y >> NCI_TNR_CHROMA_SUBSAMPLE_SHIFT)
#define Q_TNR_IN_SIZE_U                               (Q_TNR_IN_WIDTH_U * Q_TNR_IN_HEIGHT_U)

#define Q_TNR_IN_WIDTH_V                              (Q_TNR_IN_WIDTH_U)
#define Q_TNR_IN_HEIGHT_V                             (Q_TNR_IN_HEIGHT_U)
#define Q_TNR_IN_SIZE_V                               (Q_TNR_IN_SIZE_U)

#define Q_TNR_IN_SIZE                                 (Q_TNR_IN_SIZE_Y + Q_TNR_IN_SIZE_U + Q_TNR_IN_SIZE_V)
...
#define TNR_MBR_DMA_HB_REF_IN_ID                      vied_nci_dev_chn_dma_ext1_read
#define TNR_MBR_DMA_HB_REF_IN_SIZE                    (TNR_MBR_MAX_BATCH_SIZE)
...
#define TNR_MBR_DMA_INT_ID                            vied_nci_dev_chn_dma_internal
#define TNR_MBR_DMA_INT_SIZE                          TNR_MBR_NUMBER_OF_INTERNAL_DMA_CHANNELS

/* DMA ref out configuration */
#define TNR_DMA_HB_REFOUT_ID                          vied_nci_dev_chn_dma_ext1_write
#define TNR_DMA_HB_REFOUT_SIZE                        (NCI_TNR_DMA_NUM_CHANS)
