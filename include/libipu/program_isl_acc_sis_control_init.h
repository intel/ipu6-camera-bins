...
#ifndef __PROGRAM_ISL_ACC_SIS_CONTROL_INIT_H
#define __PROGRAM_ISL_ACC_SIS_CONTROL_INIT_H
 ...
 */
int
program_isl_acc_sis_get_payload_size(void);
 ...
 */
int
program_isl_acc_sis_fill_load_section_descriptor(
		ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc,
		vied_nci_lb_acb_id_t acb_id);

#endif /* __PROGRAM_ISL_ACC_SIS_CONTROL_INIT_H */
