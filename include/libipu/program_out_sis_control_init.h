...
#ifndef __PROGRAM_OUT_SIS_CONTROL_INIT_H
#define __PROGRAM_OUT_SIS_CONTROL_INIT_H
...
typedef struct {
	dfm_port_resource_t dfm_sis_s2m_port;
	dfm_port_resource_t dfm_sis_dma_port;
} dfm_sis_resources_t;
...
program_out_sis_payload_fill(
	...
	dfm_sis_resources_t dfm_resources,
 ...
 */
int
program_out_sis_get_payload_size(dfm_sis_resources_t dfm_resources);
 ...
 */
int
program_out_sis_fill_load_section_descriptor(
 ...
 */
int
program_out_sis_fill_connect_section_descriptor(
	ia_css_program_control_init_connect_section_desc_t *connect_sec_desc,
	ia_css_terminal_ID_t terminal_id,
	dma_resource_t dma_resource);

void
program_out_sis_set_desc_sid_pid(
		ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc,
		dfm_sis_resources_t dfm_resources);

#endif /* __PROGRAM_OUT_SIS_CONTROL_INIT_H */
