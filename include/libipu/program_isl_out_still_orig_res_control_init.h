...
#ifndef __PROGRAM_ISL_OUT_STILL_ORIG_RES_CONTROL_INIT_H
#define __PROGRAM_ISL_OUT_STILL_ORIG_RES_CONTROL_INIT_H
 ...
 */
int
program_isl_out_still_orig_res_payload_fill(
	...
	dfm_still_resources_t dfm_resources,
 ...
 *
 * @param[in]   dfm_still_resources            DFM ports
 * @param[in]   blocker                 Stream blocker to unblock, use STREAM_BLOCKER_NUM_DEVS for none.
 *
 * @retval	Size of the program payload
 */
int
program_isl_out_still_orig_res_get_payload_size(
	dfm_still_resources_t dfm_resources,
 ...
 */
int
program_isl_out_still_orig_res_fill_load_section_descriptor(
 ...
 */
int
program_isl_out_still_orig_res_fill_connect_section_descriptor(
	ia_css_program_control_init_connect_section_desc_t *connect_sec_desc,
	dma_resource_t dma_resource,
	ia_css_terminal_ID_t terminal_id);

void
program_isl_out_still_orig_res_set_desc_sid_pid(
		ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc,
		dfm_port_resource_t dfm_s2v);

#endif /* __PROGRAM_ISL_OUT_STILL_ORIG_RES_CONTROL_INIT_H */
