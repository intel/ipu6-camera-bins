 ...
 */
#ifndef __STRM_PACK_CONTROL_INIT_H
#define __STRM_PACK_CONTROL_INIT_H
...
int
strm_pack_payload_fill(
		struct ia_css_terminal_descriptor_s *put_terminal,
		void *payload_address);

int
strm_pack_get_payload_size(void);

int
strm_pack_fill_load_section_descriptor(
		enum ipu_device_strm_pack_dev_id strm_pack_id,
		ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc);

unsigned int
strm_pack_get_numberof_load_sections(void);

#endif /* __STRM_PACK_CONTROL_INIT_H */
