...
#ifndef __PG_187_CONTROL_INIT_H
#define __PG_187_CONTROL_INIT_H
...
int _pg_187_control_payload_init(
...
int _pg_187_get_control_payload_init_buffer_size(
		const ia_css_process_group_t *process_group,
...
int _pg_187_control_init_sec_desc_init(
		const ia_css_process_group_t *process_group,
