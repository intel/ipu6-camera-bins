...
#ifndef HOST_DAI_DEVICE_ACCESS_INTERNAL_DATA_IMPL_H_
#define HOST_DAI_DEVICE_ACCESS_INTERNAL_DATA_IMPL_H_
...
dai_internal_data_mem_store_16(const dai_device_route_t *route,
                               dai_device_memory_id_t mem, dai_address_t mem_addr,
                               uint16_t data)
{
...
_DAI_DEVICE_ACCESS_INLINE void
dai_internal_data_mem_store_32(const dai_device_route_t *route,
                               dai_device_memory_id_t mem, dai_address_t mem_addr,
                               uint32_t data)
{
...
_DAI_DEVICE_ACCESS_INLINE void
dai_internal_data_mem_store(const dai_device_route_t *route,
                            dai_device_memory_id_t mem, dai_address_t mem_addr,
                            const void *data, unsigned int size)
{
...
dai_internal_data_mem_load_8(const dai_device_route_t *route,
                             dai_device_memory_id_t mem, dai_address_t mem_addr)
{
...
dai_internal_data_mem_load_16(const dai_device_route_t *route,
                              dai_device_memory_id_t mem, dai_address_t mem_addr)
{
...
dai_internal_data_mem_load_32(const dai_device_route_t *route,
                              dai_device_memory_id_t mem, dai_address_t mem_addr)
{
...
_DAI_DEVICE_ACCESS_INLINE void
dai_internal_data_mem_load(const dai_device_route_t *route,
                           dai_device_memory_id_t mem, dai_address_t mem_addr,
                           void *data, unsigned int size)
{
...
#endif  /* HOST_DAI_DEVICE_ACCESS_INTERNAL_DATA_IMPL_H_ */
