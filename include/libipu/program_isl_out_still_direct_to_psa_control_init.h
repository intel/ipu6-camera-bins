...
#ifndef __PROGRAM_ISL_OUT_STILL_DIRECT_TO_PSA_CONTROL_INIT_H
#define __PROGRAM_ISL_OUT_STILL_DIRECT_TO_PSA_CONTROL_INIT_H
 ...
 */
int
program_isl_out_still_direct_to_psa_payload_fill(
 ...
 */
int
program_isl_out_still_direct_to_psa_get_payload_size(void);
 ...
 */
int
program_isl_out_still_direct_to_psa_fill_load_section_descriptor(
	ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc);

#endif /* __PROGRAM_ISL_OUT_STILL_DIRECT_TO_PSA_CONTROL_INIT_H */
