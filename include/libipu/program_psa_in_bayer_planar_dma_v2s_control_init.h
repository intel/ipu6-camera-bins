...
#ifndef __PROGRAM_PSA_IN_BAYER_PLANAR_DMA_V2S_CONTROL_INIT_H_
#define __PROGRAM_PSA_IN_BAYER_PLANAR_DMA_V2S_CONTROL_INIT_H_
 ...
 * @param[in]   terminal_id             Terminal ID of process group this program is connected to
 * @retval 0    Successful.
 * @retval 1    Error.
 */
int
program_psa_in_bayer_planar_dma_v2s_payload_fill(
 ...
 */
int
program_psa_in_bayer_planar_dma_v2s_get_payload_size(void);

/**
 * @brief       Fill load section descriptor of the program
 * @param[in]   prog_ctrl_init_prog_desc Pointer to the ctrl init prog descriptor
 *
 * @retval 0    Successful.
 * @retval 1    Error.
 */
int
program_psa_in_bayer_planar_dma_v2s_fill_load_section_descriptor(
 ...
 */
int
program_psa_in_bayer_planar_dma_v2s_fill_connect_section_descriptor(
	ia_css_program_control_init_connect_section_desc_t *connect_sec_desc,
	unsigned int connect_sec_count,
	int get_terminal_id);

void
program_psa_in_bayer_planar_dma_v2s_set_desc_sid_pid(ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc);

#endif /*__PROGRAM_PSA_IN_BAYER_PLANAR_DMA_V2S_CONTROL_INIT_H_ */
