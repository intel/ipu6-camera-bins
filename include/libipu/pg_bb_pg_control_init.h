...
#ifndef __PG_BB_CONTROL_INIT_H_
#define __PG_BB_CONTROL_INIT_H_
 ...
 * @retval 1    Error.
 */
int _pg_189_control_payload_init(
...
int _pg_189_control_init_sec_desc_init(
	const ia_css_process_group_t *process_group,
...
int _pg_189_get_control_payload_init_buffer_size(
	const ia_css_process_group_t *process_group,
	unsigned int *payload_size);


#endif /* __PG_BB_CONTROL_INIT_H_ */
