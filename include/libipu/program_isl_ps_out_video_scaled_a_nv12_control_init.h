...
#ifndef __PROGRAM_ISL_PS_OUT_VIDEO_SCALED_A_NV12_CONTROL_INIT_H
#define __PROGRAM_ISL_PS_OUT_VIDEO_SCALED_A_NV12_CONTROL_INIT_H
 ...
 */
int
program_isl_ps_out_video_scaled_a_nv12_payload_fill(
 ...
 */
int
program_isl_ps_out_video_scaled_a_nv12_get_payload_size(void);
 ...
 */
int
program_isl_ps_out_video_scaled_a_nv12_fill_load_section_descriptor(
 ...
 */
int
program_isl_ps_out_video_scaled_a_nv12_fill_connect_section_descriptor(
	ia_css_program_control_init_connect_section_desc_t *connect_sec_desc,
	unsigned int terminal_id);

void
program_isl_ps_out_video_scaled_a_nv12_set_desc_sid_pid(
		ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc);

#endif /* __PROGRAM_ISL_PS_OUT_VIDEO_SCALED_A_NV12_CONTROL_INIT_H */
