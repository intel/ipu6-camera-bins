...
#ifndef __DFM_PSA_V2S_YUV_INIT_SHARED_H
#define __DFM_PSA_V2S_YUV_INIT_SHARED_H

#include "ia_css_common_io_types.h"
#include "bufqueue.shared.h"
#include "resource.shared.h"

static void dfm_psa_v2s_yuv_open(s_resolution_t res,
					bufqueue_t q,
...
#include "dfm_psa_v2s_yuv_init.shared.c"
#endif
#endif /* __DFM_PSA_V2S_YUV_INIT_SHARED_H */
