...
#ifndef __PROGRAM_ISL_OUT_STILL_PLANAR_CONTROL_INIT_H
#define __PROGRAM_ISL_OUT_STILL_PLANAR_CONTROL_INIT_H
 ...
 * @param[in]   blocker                 Stream blocker to unblock, use STREAM_BLOCKER_NUM_DEVS for none.
 *
 * @retval 0    Successful.
 * @retval 1    Error.
 */
int
program_isl_out_still_planar_payload_fill(
	...
	dfm_planar_resources_t dfm_resources,
	pg_planar_ext_resources_t ext_resources,
	vied_nci_stream_blocker_id_t blocker,
	uint16_t frag_idx,
	uint32_t stream_id_gr,
	uint32_t stream_id_r,
	uint32_t stream_id_b,
	uint32_t stream_id_gb);
 ...
 */
int
program_isl_out_still_planar_get_payload_size(
	dfm_planar_resources_t dfm_resources,
	unsigned int dma_res_size,
	vied_nci_stream_blocker_id_t blocker);
 ...
 */
int
program_isl_out_still_planar_fill_load_section_descriptor(
	ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc,
	vied_nci_s2v_id_t s2v_id,
	dfm_planar_resources_t dfm_resources,
	resource_t dma_resource,
	vied_nci_stream_blocker_id_t blocker);
 ...
 */
int
program_isl_out_still_planar_fill_connect_section_descriptor(
	ia_css_program_control_init_connect_section_desc_t *connect_sec_desc,
	ia_css_terminal_ID_t terminal_id,
	resource_t dma_out_chan);

void
program_isl_out_still_planar_set_desc_sid_pid(
		ia_css_program_control_init_program_desc_t *prog_ctrl_init_prog_desc,
		dfm_port_resource_t dfm_s2v);

#endif /* __PROGRAM_ISL_OUT_STILL_PLANAR_CONTROL_INIT_H */
