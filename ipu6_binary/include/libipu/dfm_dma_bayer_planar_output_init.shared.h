...
#ifndef DFM_DMA_BAYER_PLANAR_INIT_SHARED_H_
#define DFM_DMA_BAYER_PLANAR_INIT_SHARED_H_
...
static void dfm_dma_bayer_planar_open(p_terminal_config terminal,
				bufqueue_t q_in,
				resource_t dma_res,
				unsigned ack_addr,
				unsigned ack_data,
...
#include "dfm_dma_bayer_planar_output_init.shared.c"
#endif

#endif /* DFM_DMA_BAYER_PLANAR_INIT_SHARED_H_ */
