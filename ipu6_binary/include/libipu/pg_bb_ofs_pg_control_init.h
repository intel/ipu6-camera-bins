...
#ifndef __PG_BB_OFS_CONTROL_INIT_H_
#define __PG_BB_OFS_CONTROL_INIT_H_
...
int
_pg_188_control_init_sec_desc_init(
	const ia_css_process_group_t *process_group,
	ia_css_program_control_init_terminal_t *terminal,
	unsigned int *payload_size);

int
_pg_188_get_control_payload_init_buffer_size(
	const ia_css_process_group_t *process_group,
	unsigned int *payload_size);


#endif /* __PG_BB_OFS_CONTROL_INIT_H_ */
